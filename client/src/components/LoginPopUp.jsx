...
const LoginPopUp = ({ setShowLogin }) => {
  ...
  return (
    <div>
      <form onSubmit={(event) => onLogin(event)} className='flex flex-col items-center gap-4 px-4 py-2'>
        <div>
        ...
        <div>
          {currentState == 'Login'
            ? <>
              <p>Forgot Password?</p>
              <button type='submit' className='px-6 py-2 bg-blue-600 text-white font-serif rounded-full'></button></>
